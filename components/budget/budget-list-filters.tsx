...
export const DEFAULT_BUDGET_FILTERS: BudgetListFilters = {
  search: "",
  unit: "All Units",
  status: "all",
  fiscalYear: "all",
...
interface BudgetListFiltersBarProps {
  filters: BudgetListFilters
  onChange: (filters: BudgetListFilters) => void
}

const FISCAL_YEARS = ["2024", "2025", "2026"] as const

export function BudgetListFiltersBar({
  filters,
  onChange,
}: BudgetListFiltersBarProps) {
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <Input
            placeholder="Search budget ID or description..."
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {(
                      Object.entries(BUDGET_STATUS_LABELS) as [
                        BudgetStatus,
                        string,
                      ][]
                    ).map(([value, label]) => (
      ...
      {activeFilterCount > 0 && (
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {filters.status !== "all" && (
            <Badge variant="secondary" className="gap-1 pr-1 text-xs font-normal">
              Status: {BUDGET_STATUS_LABELS[filters.status]}
              <button
                type="button"
                className="ml-0.5 rounded-full p-0.5 hover:bg-muted-foreground/20"
